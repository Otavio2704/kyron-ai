package otavio.kytrionyxai.ollama;
...
import otavio.kytrionyxai.chat.ConversationService;
import otavio.kytrionyxai.chat.Message;
import otavio.kytrionyxai.code.CodeGenerationService;
import otavio.kytrionyxai.github.GitHubService;
import otavio.kytrionyxai.memory.MemoryService;
import otavio.kytrionyxai.models.ModelCapabilities;
import otavio.kytrionyxai.project.ProjectService;
...
public class OllamaService {
    ...
    private static final String IDENTITY_PROMPT =
            "Você é o Kytrionyx AI, um assistente de IA local criado para rodar inteiramente " +
        ...
        streamingExecutor.execute(() -> {
            ...
            try {
                ...
                Map<String, Object> payload = buildPayload(
                    ...
                    projectId, webContexts, codeMode, githubContext);
    ...
    private String fetchFromSearXNG(String query) {
        try {
            ...
            String body = httpClient.get().uri(url)
                    .header("User-Agent", "KytrionyxAI/1.0")
